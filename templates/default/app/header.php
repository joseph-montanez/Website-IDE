...
#left-pane-outer {
    ...
    background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(200,200,200, 1.0)), to(rgba(93,93,93, 1)));
    float: left;
}
#right-pane-inner {
    margin: 10px;
...
<div id="left-pane-outer"><div id="left-pane-inner">
    <h2></h2>
    <ul>
        <li><a href="<?= $_SERVER['SCRIPT_NAME'] ?>/app/connection-edit">Add FTP/SFTP</a></li>
        <li><a href="<?= $_SERVER['SCRIPT_NAME'] ?>/logout">Logout</a></li>
    </ul>
</div></div>
